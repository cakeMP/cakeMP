...
typedef std::function<void(const std::string &text)> UITextInputCallback;

extern bool uiTextInputVisible();
extern void uiTextInputUpdate();
extern void uiTextInput(const std::string &windowTitle, const std::string &defaultText, int maxLen, UITextInputCallback callback);
